...
const testimonials = [
  {
    name: 'YMB Go Express',
    role: 'CEO',
    content: 'I am running the travel and tourism business and I am very happy with the services of Vercom Solutions.',
    rating: 5,
    avatar: 'YE',
    color: 'from-cyan-500 to-blue-600',
  },
  {
    name: 'Utkarsh Infratech',
    role: 'Director',
    content: 'We have a builder and construction business from vercom their work is Outstanding The team delivered a cutting-edge platform that scaled our operations 10x.',
    rating: 5,
    avatar: 'UI',
    color: 'from-violet-500 to-purple-600',
  },
  {
    name: 'Navjyoti Kids Villa School',
    role: 'Director',
    content: 'Professional, creative, and results-driven. Our Website and social media platform is now the industry benchmark.',
    rating: 5,
    avatar: 'NV',
  ...
  },
  {
    name: 'KYK',
    role: 'Director',
    content: 'We have the Edtech industry and The automation tools they built saved us countless hours. Highly recommended for any tech project!',
    rating: 5,
    avatar: 'KY',
  ...
  },
  {
    ...
    content: 'Their digital solutions tripled our engagement. The ROI speaks for itself!',
    rating: 5,
    avatar: 'LF',
    color: 'from-orange-500 to-amber-600',
  },
  {
    name: 'Aid For Mankind',
    role: 'CEO',
    content: 'We ran a NGO, and their work for website design and development is tremendously impressive.',
    rating: 5,
    avatar: 'AM',
  ...
  },
  {
    name: 'ReviewMyFlat',
    role: 'Director',
    content: 'We are the review platform and we are very happy with the services of Vercom Solutions.',
    rating: 5,
    avatar: 'RF',
  ...
  },
  {
    name: 'karakchaa',
    role: 'Owner',
    content: 'We are in restaurant chain, their digital menu and CRM solutions is exceptional.',
    rating: 5,
    avatar: 'K',
